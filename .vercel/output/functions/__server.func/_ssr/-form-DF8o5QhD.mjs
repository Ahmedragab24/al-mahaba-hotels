...
function BookingForm({ initial, onSaved }) {
  const { t, lang } = useI18n();
  const auth = useAuth();
  const [form, setForm] = reactExports.useState({
    customer_id: initial?.customer_id ?? "",
    currency: initial?.currency ?? "SAR",
    booking_date: initial?.booking_date ?? (/* @__PURE__ */ new Date()).toISOString().slice(0, 10),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid gap-4 p-6 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.customer_id, onValueChange: (v) => set("customer_id", v), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: t("bk.customer") }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm", children: t("bk.booking_date") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: form.booking_date, onChange: (e) => set("booking_date", e.target.value) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm", children: t("bk.special_requests") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: form.special_requests, onChange: (e) => set("special_requests", e.target.value) })
    ] }),
