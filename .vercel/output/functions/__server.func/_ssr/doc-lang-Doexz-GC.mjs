...
const DOC_LANG_LIST = ["ar", "en", "id", "ur"];
function toDocLang(v) {
...
const QUOTE_RES = {
  ar: {
    ...
    terms_text: "هذا العرض صالح حتى التاريخ المذكور أعلاه. الأسعار قابلة للتغيير حسب التوفر عند تأكيد الحجز. يخضع الحجز لسياسات الإلغاء الخاصة بكل فندق. لا يعتبر هذا العرض تأكيدًا للحجز.",
  ...
  en: {
    ...
    terms_text: "This quotation is valid until the date stated above. Prices are subject to availability at the time of booking confirmation. Bookings are subject to each hotel's cancellation policy. This quotation does not constitute a confirmed reservation.",
  ...
  id: {
    ...
    terms_text: "Penawaran ini berlaku hingga tanggal yang tercantum di atas. Harga dapat berubah sesuai ketersediaan pada saat konfirmasi pemesanan. Pemesanan tunduk pada kebijakan pembatalan masing-masing hotel. Penawaran ini bukan merupakan konfirmasi pemesanan.",
  ...
  ur: {
    ...
    notes: "نوٹس",
    terms: "شرائط و ضوابط",
    terms_text: "یہ کوٹیشن اوپر دی گئی تاریخ تک کارآمد ہے۔ قیمتیں بکنگ کی تصدیق کے وقت دستیابی سے مشروط ہیں۔ بکنگ ہر ہوٹل کی منسوخی کی پالیسی سے مشروط ہے۔ یہ کوٹیشن تصدیق شدہ بکنگ نہیں ہے۔",
...
const HOTEL_RES = {
  ar: {
    ...
    maps: "موقع الخريطة",
    near_haram: "قريب من الحرم",
    distance: "المسافة من الحرم (متر)",
    description: "الوصف",
    facilities: "المرافق",
  ...
  en: {
    ...
    website: "Website",
    maps: "Map Location",
    near_haram: "Near Haram",
    distance: "Distance from Haram (m)",
  ...
  id: {
    ...
    website: "Situs Web",
    maps: "Lokasi Peta",
    near_haram: "Dekat Haram",
    distance: "Jarak dari Haram (m)",
  ...
  ur: {
    ...
    website: "ویب سائٹ",
    maps: "نقشے پر مقام",
    near_haram: "حرم کے قریب",
    distance: "حرم سے فاصلہ (میٹر)",
    description: "تفصیل",
    facilities: "سہولیات",
    room_types: "کمروں کی اقسام",
    meal_plans: "کھانے کے پلان",
    ...
    name: "نام",
    board: "بورڈ",
    max_adults: "زیادہ سے زیادہ بالغ",
    max_children: "زیادہ سے زیادہ بچے",
    images: "تصاویر",
    bed_type: "بستر کی قسم",
    job_title: "عہدہ"
  }
};
const WA_TEMPLATES = {
...
function waTemplateExists(kind, lang) {
  const t = WA_TEMPLATES[kind][lang];
  return !!t && t.body.trim().length > 0;
}
function renderWaTemplate(kind, lang, vars) {
...
function missingDocKeys(lang, kind) {
...
export {
  ...
  DOC_LANG_LIST as a,
  missingDocKeys as m,
  renderWaTemplate as r,
  toDocLang as t,
  waTemplateExists as w
};
