...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-aK4Q-tfz.mjs");
...
const manifest = {
  "057df38c0120ceaae680e3059fe1b092a628089670ccb33b0cd8b78db4502a44": {
    functionName: "listMyHotels_createServerFn_handler",
    importer: () => import("./supplier-portal.functions-DYkJTwP8.mjs")
  },
  "13a2f9a76bf5d33bf7e6116377d6b1e86f86f21db2818697c98f58e59f946a36": {
    functionName: "runSimulationNow_createServerFn_handler",
    importer: () => import("./simulation.functions-CD-l5oWC.mjs")
  },
  "233e72260b6dbc6ca6df3cee8afd16ad27f16278b1d044ae8aa1e0f2a00eb8f3": {
    functionName: "rejectSupplierApplication_createServerFn_handler",
    importer: () => import("./supplier-applications.functions-CbelOSNT.mjs")
  },
  "2482d9d18bbbc7ca6d7b5b032f4179a4391105d3e3947316f3d5a4b4046b5083": {
    functionName: "listMyRates_createServerFn_handler",
    importer: () => import("./supplier-portal.functions-DYkJTwP8.mjs")
  },
  "459a24fc04eeb742e6c61d0b4e68d543bd96e6dcb74a2a62253595402388f04f": {
    functionName: "ensureDemoUsers_createServerFn_handler",
    importer: () => import("./demo-users.functions-BMe4h7Cc.mjs")
  },
  "5d821f56f5902eb1a268d00a3c0a6a5f474bf57b0cbbb221329d75f71f8301a4": {
    functionName: "getSimulationSettings_createServerFn_handler",
    importer: () => import("./simulation.functions-CD-l5oWC.mjs")
  },
  "614e8a025382547325883cfa13b59a50196cb833abc4320c2a249868410f5cd8": {
    functionName: "purgeSimulatedData_createServerFn_handler",
    importer: () => import("./simulation.functions-CD-l5oWC.mjs")
  },
  "6cc532cdca1d2a0cc7e4ba9d96b5f1bcf907bbc9db57b37fc309cfa074c2ed86": {
    functionName: "listMyPayables_createServerFn_handler",
    importer: () => import("./supplier-portal.functions-DYkJTwP8.mjs")
  },
  "72b5ac57297d225585f74c049f8d4e24bfefb63a9841732baf2ccf597a526432": {
    functionName: "getApplyLookups_createServerFn_handler",
    importer: () => import("./supplier-applications.functions-CbelOSNT.mjs")
  },
  "8b5cb7eda2a5c859025bea234c7243fbe3aab8f11e0c4a974d6c5e47f489734e": {
    functionName: "listMyBookings_createServerFn_handler",
    importer: () => import("./supplier-portal.functions-DYkJTwP8.mjs")
  },
  "8e45bbe7e67b9acc1c494c0ac19f0c2baff7818c13fc4000ed8ad25f311580ff": {
    functionName: "updateSimulationSettings_createServerFn_handler",
    importer: () => import("./simulation.functions-CD-l5oWC.mjs")
  },
  "959bea8a9a4718b339e568ae92c3741ddd3beecdec5ad3ab1c8251835521451e": {
    functionName: "listSupplierApplications_createServerFn_handler",
    importer: () => import("./supplier-applications.functions-CbelOSNT.mjs")
  },
  "b430ce200499dc048ab7b076e73568074561eb7efabf614ba07ce3ef399dd4bb": {
    functionName: "getMySupplierProfile_createServerFn_handler",
    importer: () => import("./supplier-portal.functions-DYkJTwP8.mjs")
  },
  "b8611767573173fcab9afceb879ad874727f709ad3c6f451d8e9c48ecb7b10d8": {
    functionName: "submitSupplierApplication_createServerFn_handler",
    importer: () => import("./supplier-applications.functions-CbelOSNT.mjs")
  },
  "b9e8df6b4da1f46baf3f4ba6ba73f427d34a2dd678fa07a13cc244b245dd1434": {
    functionName: "approveSupplierApplication_createServerFn_handler",
    importer: () => import("./supplier-applications.functions-CbelOSNT.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-v2O1Lq9M.mjs").then((n) => n.x),
    import("./start-C8M6nv8f.mjs"),
