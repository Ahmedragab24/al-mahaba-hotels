...
export const QUOTE_RES: Record<DocLang, QuoteRes> = {
  ...
  ur: {
    title: "کوٹیشن",
    company: "دلیل ٹریول اینڈ ٹورازم",
...
export const HOTEL_RES: Record<DocLang, Record<string, string>> = {
  ar: {
    ...
    company: "دليل للسفر والسياحة", print: "طباعة / حفظ PDF",
  ...
  en: {
    ...
    company: "Daleel Travel & Tourism", print: "Print / Save PDF",
  ...
  id: {
    ...
    company: "Daleel Travel & Tourism", print: "Cetak / Simpan PDF",
  ...
  ur: {
    ...
    company: "دلیل ٹریول اینڈ ٹورازم", print: "پرنٹ / PDF محفوظ کریں",
