...
export const dict: Dict = {
  ...
  "rates.room_type": { ar: "نوع الغرفة", en: "Room type" },
  "rates.view": { ar: "الإطلالة", en: "View" },
  "rates.meal_plan": { ar: "نظام الوجبات", en: "Meal plan" },
  "rates.valid_from": { ar: "من تاريخ", en: "From" },
  "rates.valid_to": { ar: "إلى تاريخ", en: "To" },
  "rates.cost": { ar: "التكلفة", en: "Cost" },
  "rates.selling": { ar: "سعر البيع", en: "Selling" },
  "rates.markup": { ar: "الهامش %", en: "Markup %" },
  "rates.min_nights": { ar: "أدنى ليالٍ", en: "Min nights" },
  "rates.max_nights": { ar: "أقصى ليالٍ", en: "Max nights" },
  "rates.release_days": { ar: "أيام الإطلاق", en: "Release days" },
  "rates.allotment": { ar: "الحصة", en: "Allotment" },
  "rates.seasons": { ar: "المواسم", en: "Seasons" },
