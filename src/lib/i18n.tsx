...
export const dict: Dict = {
  ...
  "nav.my_tasks": { ar: "مهامي", en: "My Tasks" },
  ...
  "invstatus.unpaid": { ar: "غير مدفوعة", en: "Unpaid" },
  "invstatus.cancelled": { ar: "ملغاة", en: "Cancelled" },
  "invstatus.scheduled": { ar: "مجدولة", en: "Scheduled" },
  "invstatus.overdue": { ar: "متأخرة", en: "Overdue" },
  ...
  "val.positive": {
    ar: "يجب أن تكون القيمة أكبر من صفر",
  ...
  "dashboard.welcome": {
    ar: "مرحباً بعودتك، نظرة عامة على عمليات اليوم.",
    en: "Welcome back, here is today's overview.",
  },
  "dashboard.total_bookings": { ar: "إجمالي الحجوزات", en: "Total Bookings" },
  "dashboard.pending_offers": { ar: "عروض معلقة", en: "Pending Offers" },
  "dashboard.confirmed_bookings": { ar: "حجوزات مؤكدة", en: "Confirmed Bookings" },
  "dashboard.active_suppliers": { ar: "موردين نشطين", en: "Active Suppliers" },
  "dashboard.active_hotels": { ar: "فنادق نشطة", en: "Active Hotels" },
  "dashboard.rooms_count": { ar: "عدد الغرف", en: "Rooms Count" },
  "dashboard.total_customers": { ar: "إجمالي العملاء", en: "Total Customers" },
  "dashboard.financial_receivables": { ar: "مستحقات مالية", en: "Financial Receivables" },
  "dashboard.financial_payments": { ar: "مدفوعات مالية", en: "Financial Payments" },
  "dashboard.annual_financial_performance": {
    ar: "الأداء المالي السنوي",
    en: "Annual Financial Performance",
  },
  "dashboard.revenue": { ar: "الإيرادات", en: "Revenue" },
  "dashboard.booking_status": { ar: "حالة الحجوزات", en: "Booking Status" },
  "dashboard.weekly_booking_trend": { ar: "اتجاه الحجوزات الأسبوعي", en: "Weekly Booking Trend" },
  "dashboard.booking_count_label": { ar: "حجز", en: "Bookings" },
  "dashboard.confirmed": { ar: "مؤكد", en: "Confirmed" },
  "dashboard.pending": { ar: "قيد الانتظار", en: "Pending" },
  "dashboard.cancelled": { ar: "ملغي", en: "Cancelled" },
  "dashboard.week": { ar: "أسبوع", en: "Week" },
  "dashboard.sar": { ar: "ر.س", en: "SAR" },
  "dashboard.k_sar": { ar: "ألف ر.س", en: "K SAR" },

  // Months
  "month.jan": { ar: "يناير", en: "Jan" },
  "month.feb": { ar: "فبراير", en: "Feb" },
  "month.mar": { ar: "مارس", en: "Mar" },
  "month.apr": { ar: "أبريل", en: "Apr" },
  "month.may": { ar: "مايو", en: "May" },
  "month.jun": { ar: "يونيو", en: "Jun" },
  "month.jul": { ar: "يوليو", en: "Jul" },
  "month.aug": { ar: "أغسطس", en: "Aug" },
  "month.sep": { ar: "سبتمبر", en: "Sep" },
  "month.oct": { ar: "أكتوبر", en: "Oct" },
  "month.nov": { ar: "نوفمبر", en: "Nov" },
  "month.dec": { ar: "ديسمبر", en: "Dec" },
};
